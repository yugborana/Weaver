...
class CriticAgent(BaseAgent):
    ...
    async def process(
        ...
        **kwargs
        ...
        system_prompt = """You are a Senior Research Critic.
        Your job is to strictly evaluate the provided report for:
        1. Logical consistency
        2. Depth of data (Did they answer the query?)
        3. Source credibility
        4. Hallucinations (Check for vague claims)

        Be harsh but constructive. If the report is poor, give a low score (< 7.0) to trigger a revision.
        """
